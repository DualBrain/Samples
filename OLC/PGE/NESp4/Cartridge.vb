    ...
    If ifs IsNot Nothing Then
      ...
      Select Case nMapperID
        Case 0 : pMapper = New Mapper_000(nPRGBanks, nCHRBanks)
          'Case 2 : pMapper = New Mapper_002(nPRGBanks, nCHRBanks)
          'Case 3 : pMapper = New Mapper_003(nPRGBanks, nCHRBanks)
          'Case 66 : pMapper = New Mapper_066(nPRGBanks, nCHRBanks)
      End Select
